...
description: Use when handling users data with CreateUserRecordTool.
triggers: create-user-record, create user record, create_user_record, users
---

# CreateUserRecordTool Skill

Use this skill when the user asks for data or operations related to the `users` table.

## Workflow
- Call `create_user_record` with focused arguments first.

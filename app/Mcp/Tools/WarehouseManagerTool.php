...
class WarehouseManagerTool extends Tool
{
    protected string $description = 'Manage multi-location warehouse inventory, transfers, and smart fulfillment routing';
    ...
    public function handle(Request $request, Response $response): Response
    {
        ...
        return $response->text(json_encode([
            ...
            'message' => 'WarehouseManagerTool executed successfully.',

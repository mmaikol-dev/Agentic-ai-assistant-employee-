...
class ListBudgetTransactionRecordsTool extends Tool
{
    protected string $description = 'List and filter rows from budget_transactions.';
    ...
    public function handle(Request $request, Response $response): Response
    {
        ...
        $query = DB::table('budget_transactions');
        ...
        return $response->text(json_encode([
            'type' => 'list_budget_transaction_records',
